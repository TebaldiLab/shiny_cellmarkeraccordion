...
- Load file to annotate: upload a file for automatic annotation. The file can be one of the following types:
  - The Output table generated by the FindAllMarkers function in the Seurat package, as txt, xlsx, csv or tsv file <br>
 <img src= https://github.com/user-attachments/assets/f9cad287-a438-4c49-8c20-42df010add85 style="width:50%; height:50%;">
